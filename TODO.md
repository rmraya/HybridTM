...
- Provide a CLI that can run imports (XLIFF/TMX/SDLTM/glossaries) and execute searches (concordance, semantic, translation) against a HybridTM instance for scripting and automation.
