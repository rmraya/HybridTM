...
- Import SDLTM files from Trados Studio by converting them to TMX via the `sdltm` library [https://github.com/rmraya/sdltm](https://github.com/rmraya/sdltm) so existing SDLTM assets can enter the standard HybridTM pipelines.
